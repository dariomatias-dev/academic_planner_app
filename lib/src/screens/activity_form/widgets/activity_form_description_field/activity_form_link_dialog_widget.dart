...
class ActivityFormLinkDialogWidget extends StatefulWidget {
  final String? initialText;
  final String? initialUrl;

  const ActivityFormLinkDialogWidget({
    super.key,
    this.initialText,
    this.initialUrl,
  });
  ...
  static Future<Map<String, String>?> show(
    ...
    return showDialog<Map<String, String>>(
      context: context,
      builder: (context) => ActivityFormLinkDialogWidget(
  ...
  @override
  State<ActivityFormLinkDialogWidget> createState() =>
      _ActivityFormLinkDialogWidgetState();
}

class _ActivityFormLinkDialogWidgetState
    extends State<ActivityFormLinkDialogWidget> {
