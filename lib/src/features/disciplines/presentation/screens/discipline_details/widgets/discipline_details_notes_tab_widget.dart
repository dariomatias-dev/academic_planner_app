...
final FutureProvider<List<Note>> Function(int) disciplineNotesProvider =
    FutureProvider.family<List<Note>, int>((
      ref,
      disciplineId,
    ) async {
        ...
        if (notes.isEmpty) {
          return EmptyStateWidget(
            ...
            onActionPressed: () async {
              await AppRoutes.goToNoteForm(context, disciplineId: disciplineId);
            },
          );
        }
